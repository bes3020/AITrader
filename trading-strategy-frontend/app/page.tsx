        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Describe strategies in natural language. Our AI parses and backtests them automatically.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Multiple Symbols</h3>
            <p className="text-sm text-muted-foreground">
              Test on ES, NQ, YM, BTC, and CL futures with comprehensive historical data.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Get detailed performance metrics, worst trades analysis, and actionable insights.
            </p>
          </div>
        </div>
      </div>
